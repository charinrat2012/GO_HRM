...
import 'package:go_hrm/app/data/models/appeal_status_model.dart';
...
class HistoryCardList extends GetView<AppealController> {
      ...
      () => SliverPadding(
        ...
        sliver: SliverList(
          delegate: SliverChildBuilderDelegate((context, index) {
            final item = controller.appealHistory[index];
            return Padding(
          ...
          }, childCount: controller.appealHistory.length),
        ),
      ),
    );
  }
              ...
              children: [
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(
                        isManagerView ? 'ถูกร้องเรียน' : 'ร้องเรียน',
                        // item.title,
                        style: TextStyle(
